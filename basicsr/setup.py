...
if __name__ == '__main__':
    ...
    setup(        
        name='basicsr',
        version=get_version(),
        description="Image Upscaling Application by TechMonarchs", #'Open Source Image and Video Super-Resolution Toolbox',
        long_description=readme(),
        long_description_content_type='text/markdown',
        author='Mohit Nikhade',
        author_email='mohitnikhade14@gmail.com',
        keywords='computer vision, restoration, super resolution',
        url='https://github.com/mohitniks/TechMonarchs',
